...
<div style="background: linear-gradient(135deg, #1a1a2e 0%, #16213e 50%, #0f3460 100%); border-radius: 16px; padding: 2rem; margin: 1.5rem 0; box-shadow: 0 10px 40px rgba(0,0,0,0.3); display: flex; flex-wrap: wrap; gap: 2rem; align-items: center;">
  ...
  <div style="flex: 1; min-width: 250px;">
    <p style="color: #e94560; font-size: 0.85rem; font-weight: 600; text-transform: uppercase; letter-spacing: 2px; margin: 0 0 0.5rem 0;">The Definitive Guide</p>
    <h3 style="color: #ffffff; font-size: 1.5rem; font-weight: 700; margin: 0 0 1rem 0; line-height: 1.3;">Norwegian Singles Method: Subthreshold Running Kept Simple</h3>
    <p style="color: #a0a0a0; font-size: 0.95rem; margin: 0 0 0.5rem 0;">By <span style="color: #ffffff; font-weight: 600;">James Copeland</span> (sirpoc)</p>
    <p style="color: #a0a0a0; font-size: 0.9rem; margin: 0 0 1.5rem 0;">Foreword by Marius Bakken MD</p>
